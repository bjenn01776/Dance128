...
const calDay = { year: 1955, month: 9, day: 11 };
...
function calender(e) {
    ...
    console.log("   The 1st month    number:: " + month);
    console.log("   The 1st month     name :: " + monthName); 
    console.log(`   The 1st day of the week::  ${dow}`)
...
let buildMonth = function (dow, nMonthDays) {
    ...
    for (k = 0; k < (nMonthDays); k++) {
        ...
        newDiv.addEventListener("click", (e) => {
            ...
            try {
                ...
                let dateDOM = new Date( year, month, e.target.textContent );
                console.log("    The Cal   date is::  " + dateDOM); 
                let dayName = arrDay2[dateDOM.getDay()];
                console.log("    The Cal  Day Name:: " + dayName);


                var filen = "../CalDays/dSched_" + arrMonth[month] + "_" + e.target.textContent + "_" + dayName + ".html" ;
